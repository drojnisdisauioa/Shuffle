...
5. Go to the **Shuffle** website, then **click your new bookmark** — and boom, it runs automatically.
...
9. Finally, go to the Shuffle website, open your **bookmarks**, and **tap your new bookmark** — and it runs.
...
6. That’s it! Now when you visit the Shuffle website, the script will **run automatically** in the background.
